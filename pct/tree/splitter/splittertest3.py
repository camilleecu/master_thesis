...
class Splitter3:
    ...
    def numerical_split(self, x, y, instance_weights, attribute_name, criteria, return_index):
        ...
        # Left split: y < threshold_1 or missing
        # Middle split: threshold_1 <= y < threshold_2
        # Right split: y >= threshold_2
        left_split = (y < threshold_1) | np.isnan(y)  # Left split: y < threshold_1 or missing ratings
    ...
    def calculate_thresholds(self, y):
        ...
        # Here we use percentiles to dynamically calculate thresholds
