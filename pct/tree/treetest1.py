...
from pct.tree.splitter.splittertest1 import Splitter1
...
class Tree1:
    ...
    def fit(self, x, y, target_weights=None):
        ...
        instance_weights = pd.DataFrame(np.full(x.shape[0], Tree1.INITIAL_WEIGHT), index=x.index)
        ...
        self.splitter1 = self.make_splitter()
